  ...
  theme: {
    extend: {
      colors: {
        ...
        input: "hsl(var(--input))",
        ring: "hsl(var(--ring))",
        background: "#101957", // Navy
        foreground: "#ffffff",
        primary: {
          DEFAULT: "#C8B59A", // Beige
          foreground: "#101957",
        },
        secondary: {
          DEFAULT: "#59344F", // Plum
        ...
        // Mapped legacy colors to new palette
        highlight: "#C8B59A", // Beige (was Red)
        "dark-gray": "#17215E", // Lighter Navy
        "light-gray": "#f1f1f1",
        "alpha-white": "rgba(255, 255, 255, 0.5)",
        "deep-black": "#0A1038", // Darker Navy
        "chrome-white": "#f8f8f8",
      },
      borderRadius: {
