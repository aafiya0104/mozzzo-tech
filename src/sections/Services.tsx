...
export function Services() {
  ...
  return (
    <section
      ref={sectionRef}
      id="services"
      className="relative py-32 px-8 lg:px-16 bg-navy overflow-hidden"
            ...
            >
              ...
              <div className="py-8 lg:py-12 flex items-center justify-between cursor-pointer">
                <div className="flex items-center gap-4 md:gap-8 lg:gap-16">
                  ...
                  {/* Title */}
                  <h3
                    className={`text-2xl md:text-h3 lg:text-h2 text-white font-normal transition-all duration-400 ${
