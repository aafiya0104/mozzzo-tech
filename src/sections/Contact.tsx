...
export function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.location.href = `mailto:mozzzo.tech@gmail.com?cc=mozzzo.tech@gmail.com&subject=${subject}&body=${body}`;
  };
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 relative">
          ...
          >
            ...
            <h2
              ref={titleRef}
              className="text-h3 lg:text-h2 text-navy font-medium mb-4"
            >
              {contactConfig.title}
            </h2>
            ...
            <p
              ref={subtitleRef}
              className="text-body-lg text-black/60 mb-12"
            >
            ...
            <div className="space-y-8">
              ...
              >
                <label
                  className={`absolute left-0 transition-all duration-200 ${
                    focusedField === 'name' || formData.name
                      ? '-top-6 text-body-sm text-navy'
                      : 'top-3 text-body text-black/50'
                  }`}
                >
                ...
                <input
                  ...
                  className="w-full bg-transparent border-b border-black/20 py-3 text-black focus:outline-none focus:border-navy transition-colors duration-300"
                  required
                />
                <div
                  className={`absolute bottom-0 left-0 h-px bg-navy transition-all duration-300 ${
              ...
              >
                <select
                  ...
                  onBlur={() => setFocusedField(null)}
                  className="w-full bg-transparent border-b border-black/20 py-3 text-black focus:outline-none focus:border-navy transition-colors duration-300 appearance-none cursor-pointer"
                >
              ...
              >
                ...
                <textarea
                  ...
                  onBlur={() => setFocusedField(null)}
                  rows={4}
                  className="w-full bg-transparent border-b border-black/20 py-3 text-black focus:outline-none focus:border-navy transition-colors duration-300 resize-none"
                />
                <div
                  className={`absolute bottom-0 left-0 h-px bg-navy transition-all duration-300 ${
            ...
            <button
              ref={buttonRef}
              type="submit"
              className="mt-12 px-10 py-4 bg-navy text-white text-body font-medium flex items-center gap-3 hover:bg-highlight hover:text-navy transition-colors duration-300 relative overflow-hidden group"
            >
