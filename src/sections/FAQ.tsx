  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <h2
          ref={titleRef}
          className="text-h1 lg:text-display-xl text-navy font-medium text-center mb-20"
        >
          {faqConfig.title}
        </h2>
        ...
        <div className="space-y-0">
          {faqConfig.faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <h3
                  className={`text-h5 lg:text-h4 text-navy pr-8 transition-all duration-200 ${
                ...
                <div
                  className={`flex-shrink-0 w-10 h-10 rounded-full border border-navy/30 flex items-center justify-center transition-all duration-400 ${
                    openIndex === index
